...
-- Records of think_ad
-- ----------------------------
INSERT INTO think_ad VALUES ('12345', '441', '123456', '0', null, null, 'headline——l', 'description1....', 'description2....', 'http://www.izptec.com/go1.php', 'http://www.izptec.com/', 'DELETE', 'RECEIVE', 'ACTIVE');

-- ----------------------------
-- Table structure for `think_adgroup`
-- ----------------------------
DROP TABLE IF EXISTS `think_adgroup`;
CREATE TABLE `think_adgroup` (
  `idclick_groupid` int(10) NOT NULL,
  `idclick_uid` int(10) NOT NULL,
...
-- ----------------------------
-- Records of think_adgroup
-- ----------------------------
INSERT INTO think_adgroup VALUES ('123456', '441', '12345', 'group_name2', '0', null, null, 'keywords3,keywords2,keywords1', '201.00', 'DELETE', 'RECEIVE', 'DELETE');

-- ----------------------------
-- Table structure for `think_campaign`
-- ----------------------------
DROP TABLE IF EXISTS `think_campaign`;
CREATE TABLE `think_campaign` (
  `idclick_planid` int(10) NOT NULL,
  `idclick_uid` int(10) NOT NULL,
...
-- ----------------------------
-- Records of think_campaign
-- ----------------------------
INSERT INTO think_campaign VALUES ('12345', '441', '0', '5572928024', 'campaign_name #523976704166f', '10031,10032', '10031,10032', '1', '20000.00', 'ACCELERATED', '10.00', 'ACTIVE', 'CREATE', 'QUEUE');
...
-- ----------------------------
INSERT INTO think_user VALUES ('441', '5572928024', 'CREATE', 'RECEIVE', '0', '0');
